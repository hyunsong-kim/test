...
namespace FabSimulator
{
    public class BestLotSelector
    {
        ...
        public BestLotSelector(ActiveObject target, WeightPreset preset = null)
        {
            this.target = target;
            this.preset = preset;
        }
        ...
        private void InitPreset()
        {
            ...
            {
                ModelContext.Current.ErrorLister.Write(Mozart.DataActions.ErrorType.Error, "SIM-Init",
        ...
        private void BuildPreset(WeightPreset preset)
        {
            ...
            {
                throw new InvalidOperationException(string.Format("There is no registered weight factor for preset (\'{0}\')", preset.Name));
            }
            ...
            if (factory.Weights == null)
            {
                ...
                ModelContext.Current.ErrorLister.Write("NotRegisteredWeightMethod", Mozart.DataActions.ErrorType.Error, "SIM-Init",
                    "[E33003] There is no registered weight factor method.");
                return;
            }
        ...
        public IHandlingBatch EvaluateAnSelect(IList<IHandlingBatch> lots, IDispatchContext ctx)
        {
            if (this.Comparer == null)
            ...
            var list = new List<IHandlingBatch>(lots);
            ...
            foreach (var hb in list)
            {
                ...
                if (this.comparer.Compare(bestLot, hb) > 0)
                    bestLot = hb;
            }
